...
I’ve written a "blog post":https://jonpearse.net/articles/2016/07/on-linting-and-bringing-order-to-sass about this, but the short version is I really get on with SCSS-Lint’s default @PropertySortOrder@ linter =)
